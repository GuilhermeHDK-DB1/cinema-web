...
export class ProgramacaoComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.alimentarListaDeSessoes();

    const retorno = this.service.consultarSessoesPelaData('2023-10-01')
      .subscribe(listaDeSessoes => {
        this.listaDeSessoes = listaDeSessoes
      });
    console.log(this.listaDeSessoes);
  }
  ...
  private alimentarListaDeSessoes() {
    const sessao1 : Sessao = {
      id: 69,
      nomeDoFilme: "Missão impossível 4",
      duracao: 200,
      classificacao: "PG",
      genero: "Ação",
    ...
    const sessao2 : Sessao = {
      id: 70,
      nomeDoFilme: "Ação Explosiva",
      duracao: 130,
      classificacao: "G",
      genero: "Ficcao Cietifica",
      horario: "2023-10-01T19:00:00",
      idioma: 0,
      nomeDaSala: "Sala 1",
      salaVip: true,
    ...
    this.listaDeSessoes = [sessao1, sessao2];
  }
}
